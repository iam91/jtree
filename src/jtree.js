;(function(window, document, undefined){
    ...
    var View = {
        ...
        CLASS_NAME: {
            ...
            NODE_BODY_COLLAPSED : 'dt-node__body--collapsed',
            NODE_ICON_FILE      : 'dt-node__icon--file',
            NODE_ICON_FOLDER    : 'dt-node__icon--folder',
            NODE_ICON_COLLAPSED : 'dt-node__icon--collapsed',
    ...
    TreeNode.prototype = {
         ...
         _render: function(){
            ...
            var ic = View.getIcon(this._el);
            ic.classList.add(CLASS_NAME.NODE_ICON_COLLAPSED);
            var bd = View.getBody(this._el);
            bd.classList.add(CLASS_NAME.NODE_BODY_COLLAPSED);
        ...
        expand: function(){
            ...
            ic.classList.remove(CLASS_NAME.NODE_ICON_COLLAPSED);
            bd.classList.remove(CLASS_NAME.NODE_BODY_COLLAPSED);
            this._expanded = true;
        },
